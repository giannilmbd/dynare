...
Dynare works on top of MATLAB®, any version ranging from 9.8 (R2020a) to 25.2
(R2025b). Only 64-bit versions are supported.
...
This version of Dynare is compiled for Octave 10.3.0 (MinGW, 64-bit),
and may not work with other versions of Octave. The recommended version of
Octave can be downloaded at:
  https://ftpmirror.gnu.org/gnu/octave/windows/octave-10.3.0-w64-installer.exe
