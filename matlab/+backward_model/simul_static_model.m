function [simulation, oo_, errorflag]= simul_static_model(M_,options_,oo_,samplesize, innovations)
% [simulation, oo_, errorflag]= simul_static_model(M_,options_,oo_,samplesize, innovations)
...
% - oo_                 [struct]      Dynare's results structure
% - errorflag           [bool]        indicator whether simulation was successful
%
% REMARKS
...
% Set innovations.
if nargin<5 || isempty(innovations)
