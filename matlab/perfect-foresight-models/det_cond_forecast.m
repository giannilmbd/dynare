function data_set = det_cond_forecast(plan, dset, range)
...
%  o dset                 [dseries]     The initial values of the shocks and the endogenous variables (usually the dseries generated by the smoother).
%  o range                [dates]       The dates of the forecast.
%
% OUTPUTS
