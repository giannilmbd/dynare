...
function [accepted_draws_this_chain, feval_this_chain, draw_iter, ...
    ...
    draw_index_current_file, NewFile_cb, sampler_options] = computeMHBlock(curr_block, options_, InitialSeeds_cb, BaseName, OpenOldFile_cb, NewFile_cb, ...
...
while draw_iter <= nruns_cb
    ...
    [par, logpost, accepted, neval, sampler_options] = posterior_sampler_iteration(objective_function, last_draw_cb, last_posterior_cb, sampler_options,dataset_,dataset_info,options_,M_,estim_params_,bayestopt_,mh_bounds,dr, endo_steady_state, exo_steady_state, exo_det_steady_state);
