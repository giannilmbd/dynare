...
verbatim;
  ...
  y3n = repmat(y, 3, 1);
  [residual, T_order, T] = example1.dynamic_resid(y3n, x', M_.params, oo_.steady_state);
  g1 = example1.dynamic_g1(y3n, x', M_.params, oo_.steady_state, M_.dynamic_g1_sparse_rowval, M_.dynamic_g1_sparse_colval, M_.dynamic_g1_sparse_colptr, T_order, T);
