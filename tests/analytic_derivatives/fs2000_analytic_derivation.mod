...
if (isoctave && user_has_octave_package('optim', '1.6')) || (~isoctave && user_has_matlab_license('optimization_toolbox'))
    estimation(order=1,mode_compute=1,mode_file='fs2000_analytic_derivation/Output/fs2000_analytic_derivation_mode',analytic_derivation,kalman_algo=1,datafile=my_data,nobs=500,mh_replic=0,mh_nblocks=2,mh_jscale=0.8,plot_priors=0,frequentist_smoother=false
...
estimation(order=1,mode_compute=4,silent_optimizer,mode_file='fs2000_analytic_derivation/Output/fs2000_analytic_derivation_mode',analytic_derivation,kalman_algo=1,datafile=my_data,nobs=500,mh_replic=0,mh_nblocks=2,mh_jscale=0.8,plot_priors=0,frequentist_smoother=false);
estimation(order=1,mode_compute=4,silent_optimizer,mode_file='fs2000_analytic_derivation/Output/fs2000_analytic_derivation_mode',analytic_derivation,kalman_algo=2,datafile=my_data,nobs=500,mh_replic=0,mh_nblocks=2,mh_jscale=0.8,plot_priors=0,frequentist_smoother=false);
options_.debug=1;
estimation(order=1,mode_compute=0,mode_file='fs2000_analytic_derivation/Output/fs2000_analytic_derivation_mode',analytic_derivation,kalman_algo=1,datafile=my_data,nobs=500,mh_replic=0,plot_priors=0,frequentist_smoother=false);
