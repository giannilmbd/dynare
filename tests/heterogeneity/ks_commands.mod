...
verbatim;
    ...
    assert(isfield(oo_.heterogeneity, 'ss'), 'TEST 1 FAILED: Missing steady state');
    assert(isfield(oo_.heterogeneity.ss, 'agg'), 'TEST 1 FAILED: Missing aggregate variables');
    assert(isfield(oo_.heterogeneity.ss, 'pol'), 'TEST 1 FAILED: Missing policy functions');
