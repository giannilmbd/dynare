...
osr(analytic_derivation,opt_algo=4,silent_optimizer,order=1);
osr(analytic_derivation,order=1,silent_optimizer,opt_algo=1,optim=('DerivativeCheck','on','FiniteDifferenceType','central'));